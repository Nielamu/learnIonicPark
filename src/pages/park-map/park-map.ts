  ...
  initalizeMap() {
    ...
    this.parkData.getParks().then(theResult => {
      ...
      for (let thePark of this.parks) {
        ...
        let parkMarker:google.maps.Marker = new CustomMarker(thePark);
        ...
        google.maps.event.addListener(parkMarker,"click",() =>{
          let selectedMaker: any=parkMarker;

          this.navCtrl.push(ParkDetailsPage,{parkData:selectedMaker.parkData});
        })
      }
    })
